...
public class BalanceService {
    ...
    public CommunicationDto openDevizniRacun(DevizniRacunDto devizniRacunDto) {
        ...
        if (racunStorageRepository
                .findRacunStorageByBalanceRegistrationNumber(registrationNumber)
                .isPresent())
            registrationNumber = generateRandomNumber(10); // za slucaj da se nekim sudom ponovi broj 1/1 000 000

        DevizniRacun newDevizniRacun = new DevizniRacun(
                registrationNumber,
                devizniRacunDto.getOwnerId(),
                5000.0,
                5000.0,
                devizniRacunDto.getAssignedAgentId(),
                dtf.format(now),
                null,
                devizniRacunDto.getCurrency(),
                BalanceStatus.ACTIVE,
                devizniRacunDto.getBalanceType(),
                devizniRacunDto.getInterestRatePercentage(),
                devizniRacunDto.getAccountMaintenance(),
                defaultCurrency,
                devizniRacunDto.getAllowedCurrencies());
        devizniRacunRepository.save(newDevizniRacun);
        racunStorageRepository.save(
                new RacunStorage(newDevizniRacun.getRegistrationNumber(), newDevizniRacun.getType()));
    ...
    public CommunicationDto openTekuciRacun(TekuciRacunDto tekuciRacunDto) {
        ...
        TekuciRacun newTekuciRacun = new TekuciRacun(
                registrationNumber,
                tekuciRacunDto.getOwnerId(),
                5000.0,
                5000.0,
                tekuciRacunDto.getAssignedAgentId(),
                dtf.format(now),
                null,
                tekuciRacunDto.getCurrency(),
                BalanceStatus.ACTIVE,
                tekuciRacunDto.getBalanceType(),
                tekuciRacunDto.getInterestRatePercentage(),
                tekuciRacunDto.getAccountMaintenance());
    ...
    public CommunicationDto openPoslovniRacun(PoslovniRacunDto poslovniRacunDto) {
        ...
        PoslovniRacun newPoslovniRacun = new PoslovniRacun(
                registrationNumber,
                poslovniRacunDto.getOwnerId(),
                5000.0,
                5000.0,
                poslovniRacunDto.getAssignedAgentId(),
                dtf.format(now),
                null,
                poslovniRacunDto.getCurrency(),
                BalanceStatus.ACTIVE,
                poslovniRacunDto.getBussinessAccountType());
        poslovniRacunRepository.save(newPoslovniRacun);
        racunStorageRepository.save(
                new RacunStorage(newPoslovniRacun.getRegistrationNumber(), newPoslovniRacun.getType()));
