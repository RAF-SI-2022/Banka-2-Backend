package rs.edu.raf.si.bank2.Bank2Backend.cucumber.integration.usersFailures;
...
import rs.edu.raf.si.bank2.Bank2Backend.cucumber.integration.users.UsersIntegrationTestConfig;
...
public class UserFailuresSteps extends UsersIntegrationTestConfig {
    ...
    public void user_doesnt_exist_in_database() {
        try {
            ...
            String expectedMessage =
                    "Request processing failed; nested exception is rs.edu.raf.si.Bank2Backend.exceptions.Bank2Backend.UserNotFoundException: User with id <-1> not found.";
            String actualMessage = exception.getMessage();
            assertEquals(actualMessage, expectedMessage);
        } catch (Exception e) {
            fail(e.getMessage());
    ...
    public void deleting_nonexistent_user_from_database() {
        try {
            ...
            String expectedMessage =
                    "Request processing failed; nested exception is org.springframework.dao.EmptyResultDataAccessException: No class rs.edu.raf.si.bank2.Bank2Backend.models.users.User entity with id -1 exists!";
            String actualMessage = exception.getMessage();
            assertEquals(actualMessage, expectedMessage);
        } catch (Exception e) {
            fail(e.getMessage());
