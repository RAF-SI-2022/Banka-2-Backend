...
public class BootstrapData implements CommandLineRunner {
    ...
    /**
     * TODO promeniti ovo pre produkcije.
     * Promenjen admin mejl da bismo mu zapravo imali pristup.
     * Mogu da podesim forwardovanje ako je potrebno nekom
     * drugom jos pristup.
     */
    private static final String ADMIN_EMAIL = "anesic3119rn+banka2backend+admin@raf.rs";
    /**
     * TODO promeniti password ovde da bude jaci! Eventualno
     * TODO napraviti da se auto-generise novi password pri
     * TODO svakoj migraciji.
     */
