package rs.edu.raf.si.bank2.securities.cucumber.integration.exchangesFailure;
    ...
    public void get_nonexistent_exchange_by_id() {
        try {
            ...
            String expectedMessage =
                    "Request processing failed; nested exception is rs.edu.raf.si.Bank2Backend.exceptions.Bank2Backend.ExchangeNotFoundException";
            String actualMessage = exception.getMessage();
            assertEquals(actualMessage, expectedMessage);
        } catch (Exception e) {
            fail(e.getMessage());
