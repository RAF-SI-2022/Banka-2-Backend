package rs.edu.raf.si.bank2.securities.cucumber.integration.usersFailures;
...
import rs.edu.raf.si.bank2.securities.cucumber.integration.users.UsersIntegrationTestConfig;
...
public class UserFailuresSteps extends UsersIntegrationTestConfig {
    ...
    public void deleting_nonexistent_user_from_database() {
        try {
            ...
            String expectedMessage =
                    "Request processing failed; nested exception is org.springframework.dao.EmptyResultDataAccessException: No class rs.edu.raf.si.bank2.securities.models.users.User entity with id -1 exists!";
            String actualMessage = exception.getMessage();
            assertEquals(actualMessage, expectedMessage);
        } catch (Exception e) {
            fail(e.getMessage());
