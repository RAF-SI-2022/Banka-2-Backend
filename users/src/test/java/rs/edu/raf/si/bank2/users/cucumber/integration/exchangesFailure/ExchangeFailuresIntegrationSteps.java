package rs.edu.raf.si.bank2.users.cucumber.integration.exchangesFailure;
    ...
    public void get_nonexistent_exchange_by_id() {
        try {
            ...
            String expectedMessage =
                    "Request processing failed; nested exception is rs.edu.raf.si.bank2.users.exceptions.ExchangeNotFoundException: Requested exchange not found in the database.";
            String actualMessage = exception.getMessage();
            assertEquals(expectedMessage, actualMessage);
        } catch (Exception e) {
            fail(e.getMessage());
