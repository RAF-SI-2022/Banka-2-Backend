...
import rs.edu.raf.si.bank2.otc.exceptions.BalanceNotFoundException;
...
import rs.edu.raf.si.bank2.otc.repositories.mariadb.FutureRepository;
...
import rs.edu.raf.si.bank2.otc.services.interfaces.FutureServiceInterface;
import rs.edu.raf.si.bank2.otc.services.workerThreads.FutureBuyWorker;
import rs.edu.raf.si.bank2.otc.services.workerThreads.FutureSellWorker;
...
public class FutureService implements FutureServiceInterface {
    ...
    public Future processFutureBuyRequest(
        ...
        Transaction transaction = this.transactionService.createFutureOrderTransaction(
                order, balance, priceDouble.floatValue(), futureRequest,
