...
public class FileController {
    ...
    public ResponseEntity<?> upload(@RequestParam("file") MultipartFile file) throws IOException {
        ...
        // TransactionElement("123",ContractElements.SELL,TransactionElements.STOCK,ContractElements.CASH,"USD",12,12.2,1l,2l,"future");
        //        TransactionElement transactionElement2 = new
        // TransactionElement("123",ContractElements.SELL,TransactionElements.STOCK,ContractElements.CASH,"USD",12,12.2,1l,2l,"future");
        //        TransactionElement transactionElement3 = new
        // TransactionElement("123",ContractElements.SELL,TransactionElements.STOCK,ContractElements.CASH,"USD",12,12.2,1l,2l,"future");
        //
        //        Contract contract = new Contract("123", contractElements1,"creation","last","number","desc",
        // List.of(transactionElement, transactionElement2, transactionElement3));
